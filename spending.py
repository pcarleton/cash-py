...
import logging
from secrets import CLIENT_ID, CLIENT_SECRET, PAUL_TOKEN, TAYLOR_TOKEN, NICKNAMES
...
def get_budget_spreadsheet():
    ...
    auth_options = gsheets.auth.AuthOptions(credentials_dir=creds_dir)
    spreadsheet = gsheets.get_spreadsheet(spreadsheet_name, options=auth_options)
